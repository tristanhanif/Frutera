...
<template>
  <div class="min-h-screen flex flex-col lg:flex-row overflow-hidden">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
      <div class="w-full max-w-md">
        ...
        <form class="space-y-5" @submit.prevent="handleSubmit">
          <!-- Name Fields with staggered animations -->
          ...
          <!-- Sign Up Button with pulse animation when submitting -->
          <button type="submit"
        ...
        <div class="mt-8 text-center text-sm animate-fade-in" style="animation-delay: 0.8s">
          ...
          <a href="#" class="ml-1 text-green-600 hover:text-green-500 font-medium transition duration-300" @click.prevent="signIn">
            Sign In
          </a>
        </div>
      </div>
    ...
    <!-- Right Section - Green Background with floating animation -->
    <div class="hidden lg:block lg:w-1/2 bg-[#1C8057] relative overflow-hidden">
      <div class="flex items-center justify-center p-12 h-full flex-col">
        ...
        <!-- Fruit image with subtle floating animation -->
